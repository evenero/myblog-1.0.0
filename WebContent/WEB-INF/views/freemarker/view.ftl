	...
	<footer>
	  <div class="footer-mid">
	    ...
	    <div class="visitors">
	      ...
	      <dl>
	        <dt><img src="${base}/resources/images/s7.jpg">
	        <dt>
	        <dd>yisa
	          <time>2小时前</time>
	        </dd>
	      ...
	      <dl>
	        <dt><img src="${base}/resources/images/s6.jpg">
	        <dt>
	        <dd>小林博客
	          <time>8月7日</time>
	        </dd>
	    ...
	    <section class="flickr">
	      ...
	      <ul>
	        ...
	        <li><a href="/"><img src="${base}/resources/images/04.jpg"></a></li>
	        <li><a href="/"><img src="${base}/resources/images/05.jpg"></a></li>
	        <li><a href="/"><img src="${base}/resources/images/06.jpg"></a></li>
	        <li><a href="/"><img src="${base}/resources/images/07.jpg"></a></li>
	        <li><a href="/"><img src="${base}/resources/images/08.jpg"></a></li>
	        <li><a href="/"><img src="${base}/resources/images/09.jpg"></a></li>
	      </ul>
	    </section>
	  </div>
